	...
	$(document).ready(function()
	{
		...
		/* Morris.Bar({
			...
			Morris.Bar({
				element: 'chart4',
				data: [
					{x: 'Campaign 1', y: getRandomInt(1,10), z: getRandomInt(1,20), a: getRandomInt(1,20)},
					{x: 'Campaign 2', y: getRandomInt(1,11), z: getRandomInt(1,10), a: getRandomInt(1,14)},
					{x: 'Campaign 3', y: getRandomInt(1,20), z: getRandomInt(1,20), a: getRandomInt(1,19)},
					{x: 'Campaign 4', y: getRandomInt(1,15), z: getRandomInt(1,15), a: getRandomInt(1,11)}
				],
				xkey: 'x',
				ykeys: ['y', 'z', 'a'],
				labels: ['Users Phished', 'Users Clicked', 'Entered Credentials'],
				stacked: true,
				barColors: ['#00a65a', '#facd05', '#f4543c']
			});
			...
			Morris.Donut({
				element: 'chart5',
				data: [
					{label: "Click", value: getRandomInt(10,50)},
					{label: "No Click", value: getRandomInt(10,50)},
				],
				colors: ['#f26c4f', '#00bff3']
			});
			...
			Morris.Donut({
				element: 'chart6',
				data: [
					{label: "Credentials", value: getRandomInt(10,50)},
					{label: "No Credentials", value: getRandomInt(10,50)},
				],
				labelColor: '#303641',
				colors: ['#f26c4f', '#00bff3']
			});
			...
			Morris.Donut({
				element: 'chart7',
				data: [
					{label: "Mobile", value: getRandomInt(10,50)},
					{label: "Desktop", value: getRandomInt(10,50)},
				],
				labelColor: '#303641',
				colors: ['#f26c4f', '#00bff3']
			});
			...
			Morris.Donut({
				element: 'topos',
				data: [
					{label: "Linux", value: getRandomInt(10,50)},
					{label: "Windows", value: getRandomInt(10,50)},
					{label: "macOS", value: getRandomInt(10,50)},
				],
				colors: ['#ba79cb', '#0073b7', '#e8e8e8']
			});
			...
			Morris.Donut({
				element: 'topbrows',
				data: [
					{label: "Firefox", value: getRandomInt(10,50)},
					{label: "Safari", value: getRandomInt(10,50)},
					{label: "Google Chrome", value: getRandomInt(10,50)},
					{label: "Internet Explorer", value: getRandomInt(10,50)},
				],
				colors: ['#f26c4f', '#00bff3', '#00a65a', '#0073b7']
			});
			...
			Morris.Donut({
				element: 'triage',
				data: [
					{label: "Emails Reported", value: getRandomInt(10,50)},
					{label: "Simulations Reported", value: getRandomInt(10,50)},
				],
				colors: ['#facd05', '#00a65a']
			});
